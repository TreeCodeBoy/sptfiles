...
class WTTArmoryM249 {
    ...
    displayCreditBanner() {
        this.instanceManager.colorLog(`[${this.modName}] A Collaboration between Choccster and the WTT Team
                                                                        Kept you waiting, huh?`, "green");
    }
}
module.exports = { mod: new WTTArmoryM249() };
