...
class PackNStrap
    ...
    public postDBLoad(container: DependencyContainer): void {
        ...
        if (config.loseArmbandOnDeath) {
            const dblostondeathConfig = this.instanceManager.configServer.getConfig<ILostOnDeathConfig>(ConfigTypes.LOST_ON_DEATH)
    ...
    public keepItemsInArmbandAfterDeath(): void {
        this.instanceManager.container.afterResolution("InRaidHelper", (_, result: any) => {
            const originalisItemKeptAfterDeath = result.isItemKeptAfterDeath;
    
            result.isItemKeptAfterDeath = (pmcData: IPmcData, itemToCheck: IItem): boolean => {
